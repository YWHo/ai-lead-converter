...
const Features = () => {
  return (
    <div className="relative px-8 pb-12 pt-8 sm:py-12">
      <div className="absolute inset-0 z-0 -skew-y-6 transform bg-gradient-to-r from-purple-100 to-purple-50" />
      <div className="relative z-10 flex flex-col justify-center space-y-10 px-8 pb-12 pt-8 sm:py-12 md:flex-row md:space-y-0">
        <FeatureCard
...
const CallToAction = () => {
  return (
    <div className="flex flex-col items-center bg-white px-6 py-16 text-center">
      ...
      <Link href="/lead-magnets">
        <Button className="text-sm px-2 py-3 sm:text-lg mt-4">
          Create Your First AI Lead Magnet
        </Button>
      </Link>
    </div>
